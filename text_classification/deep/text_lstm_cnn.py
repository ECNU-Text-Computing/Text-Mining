...
class LSTMCNN(TextRNN):
    def __init__(self, vocab_size, embed_dim, hidden_dim, num_classes,
                 dropout_rate, learning_rate, num_epochs, batch_size,
                 criterion_name, optimizer_name, gpu, **kwargs):
        # 调用父类BaseModel
        super(LSTMCNN, self).__init__(vocab_size, embed_dim, hidden_dim, num_classes,
                                      dropout_rate, learning_rate, num_epochs, batch_size,
                                      criterion_name, optimizer_name, gpu, **kwargs)
        ...
        self.convs = nn.ModuleList([nn.Conv2d(1, self.num_filters, (k, self.hidden_dim * self.num_directions))
