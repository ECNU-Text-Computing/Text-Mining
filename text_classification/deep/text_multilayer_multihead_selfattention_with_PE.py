...
class MultiLayerMultiHeadSelfAttentionWithPE(BaseModel):
    def __init__(self, vocab_size, embed_dim, hidden_dim, num_classes,
                 dropout_rate, learning_rate, num_epochs, batch_size,
                 criterion_name, optimizer_name, gpu, **kwargs):
        super(MultiLayerMultiHeadSelfAttentionWithPE, self).__init__(vocab_size, embed_dim, hidden_dim, num_classes,
                                                                     dropout_rate, learning_rate, num_epochs, batch_size,
                                                                     criterion_name, optimizer_name, gpu, **kwargs)
        self.num_encoder = 6
...
if __name__ == '__main__':
    ...
    if args.phase == 'test':
        ...
        model = MultiLayerMultiHeadSelfAttentionWithPE(vocab_size, embed_dim, hidden_dim, num_classes,
                                                       dropout_rate, learning_rate, num_epochs, batch_size,
    ...
    print('Done MultiLayerMultiHeadSelfAttentionWithPE!')