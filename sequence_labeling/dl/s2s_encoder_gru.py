...
class EncoderGRU(nn.Module):
    ...
    def init_hidden(self):  # 初始化hidden
        return torch.zeros(self.num_layers * self.n_directions, 1, self.hidden_dim, device=device)  # batch_size = 1
...
if __name__ == '__main__':
    ...
    print(type(EncoderGRU()).__name__)